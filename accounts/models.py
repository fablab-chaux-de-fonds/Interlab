...
class SuperUserProfile(models.Model):
    ...
    status = models.ManyToManyField(SuperUserStatus, verbose_name=_("Status"), blank=True)
    trainer = models.ManyToManyField("machines.Training", verbose_name=_("Trainer"), blank=True)
    technique = models.ManyToManyField("machines.Workshop", verbose_name=_("Technique"), blank=True)
    software = models.ManyToManyField("machines.Software", verbose_name=_("Software"), blank=True)
    machine_category =  models.ManyToManyField("machines.MachineCategory", verbose_name=_("Machine category"), blank=True)
